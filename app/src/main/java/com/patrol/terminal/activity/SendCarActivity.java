...
public class SendCarActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleName.setText("派车单");
        titleSetting.setVisibility(View.VISIBLE);
        titleSettingTv.setText("申请");
    }

    @OnClick({R.id.title_back, R.id.title_setting, R.id.ll_date, R.id.ll_time, R.id.ll_place, R.id.ll_start_time, R.id.ll_end_time, R.id.iv_signature_pad})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_start_time:
                PickerUtils.showTime(this, tvStartTime);
                break;
            case R.id.ll_end_time:
                PickerUtils.showTime(this, tvEndTime);
                break;
            case R.id.ll_place:
