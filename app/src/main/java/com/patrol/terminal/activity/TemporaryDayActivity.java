...
public class TemporaryDayActivity extends BaseActivity {
    ...
    private void initview() {
        ...
        year = split[0];
        day = split[2];
        starttime=DateUatil.getDate(new Date(System.currentTimeMillis()));
        endTime=DateUatil.getDate(new Date(System.currentTimeMillis()));
        monthPlanStart.setText(time);
        monthPlanEnd.setText(time);
        getLineType();
    }
    ...
    public void saveDayPlan() {
        ...
        BaseRequest.getInstance().getService()
                ...
                .subscribe(new BaseObserver<List<LineTypeBean>>(this) {
                    ...
                    protected void onSuccees(BaseResult<List<LineTypeBean>> t) throws Exception {
                        if (t.getCode() == 1) {
                            Toast.makeText(TemporaryDayActivity.this, "制定成功", Toast.LENGTH_SHORT).show();
                            setResult(RESULT_OK);
                            finish();
                        }
                    }
        ...
        BaseRequest.getInstance().getService()
                ...
                .subscribe(new BaseObserver<List<Tower>>(this) {
                    ...
                    protected void onSuccees(BaseResult<List<Tower>> t) throws Exception {
                        ...
                        TempTowerAdapter adapter=new TempTowerAdapter(TemporaryDayActivity.this,t.getResults());
