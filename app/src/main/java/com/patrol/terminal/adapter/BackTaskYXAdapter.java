...
public class BackTaskYXAdapter extends BaseQuickAdapter<PersonalTaskListBean, BaseViewHolder> {


    public BackTaskYXAdapter(int layoutResId, @Nullable List<PersonalTaskListBean> data) {
