...
public class LineTypeSelectAdapter extends BaseAdapter {
    ...
    public LineTypeSelectAdapter(Context context, List<PlanTypeBean> traceList) {
        this.context = context;
        this.lineTypeBeans = traceList;
    }

    public LineTypeSelectAdapter(Context context, List<PlanTypeBean> selectType, List<EqTower> eqTowers,List<String>  names) {
        this.context = context;
    ...
    public void  setdata(List<EqTower> eqTowers,List<String> names){
        this.eqTowers=eqTowers;
        this.towerList=names;
        notifyDataSetChanged();
    }
