...
public class MonthPlanDetailAdapter extends BaseQuickAdapter<DefectBean, BaseViewHolder> {



    public MonthPlanDetailAdapter(int layoutResId, @Nullable List<DefectBean> data) {
