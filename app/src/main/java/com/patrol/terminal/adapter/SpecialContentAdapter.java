...
public class SpecialContentAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
    ...
    private final List<SpecialAttrBean> listLevel3;
    private final List<SpecialAttrBean> listLevel4;
    ...
    public SpecialContentAdapter(List<MultiItemEntity> data, List<SpecialAttrBean> listLevel3, List<SpecialAttrBean> listLevel4) {
        super(data);
