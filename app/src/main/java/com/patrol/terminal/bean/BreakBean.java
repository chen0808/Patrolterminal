...
public class BreakBean implements Serializable {
    ...
    /**
     * id : 9D987B6487EF402D94D2CEA4C59DF81F
     * task_trouble_id : 09763F6C931747BE8BED8B717BEAA0C2
     * content : 砼杆小号侧20米处挖山平地
     * trouble_wares : 一般（III类）
     * duty_unit : 暂无
     * contact : null
     * phone : null
     * deal_notes_first : 送达隐患告知书
     * deal_notes_second : null
     * deal_notes_third : null
     * deal_notes_fourth : 现场树立警示牌
     * deal_notes_fifth : 人员动态巡视、现场监督检查
     * is_video : 否
     * plan_time : null
     * done_time : null
     * company : null
