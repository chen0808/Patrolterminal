...
public class OverhaulZzTaskBean implements Parcelable {



    /**
     * id : 7F96F922815D4940AB69CEF71981B4C3
     ...
     * week : 1
     * day : 3
     * repair_id : 708982C0A7E840F1BB58D5C362B12512
     * task_content : 123
     * task_status : 1
     * done_status : 0
     * done_time : null
    ...
    public OverhaulZzTaskBean() {
    }

    protected OverhaulZzTaskBean(Parcel in) {
    ...
    public static final Parcelable.Creator<OverhaulZzTaskBean> CREATOR = new Parcelable.Creator<OverhaulZzTaskBean>() {
        @Override
        public OverhaulZzTaskBean createFromParcel(Parcel source) {
            return new OverhaulZzTaskBean(source);
        }

        @Override
        public OverhaulZzTaskBean[] newArray(int size) {
            return new OverhaulZzTaskBean[size];
        }
    };
}
