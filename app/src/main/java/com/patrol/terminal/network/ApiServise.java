...
//                                               @Part() List<MultipartBody.Part> parts);
    ...
    //上传坐标信息
    @POST("task/gps/pdaUpdateBatchPOST")
    Observable<BaseResult> postPosition(@Body List<TaskGps> beans);
    ...
    Observable<BaseResult<List<LocalAddTrouble>>> getTroubleFragment2(@Query("line_id") String line_id, @Query("tower_id") String tower_id);//, @Query("in_status") String in_status
...
//    Observable<BaseResult> releaseDeal(@Body OverhaulZZSendBean bean);
    ...
    Observable<BaseResult> projectSavePOST(@PartMap Map<String, RequestBody> params);
