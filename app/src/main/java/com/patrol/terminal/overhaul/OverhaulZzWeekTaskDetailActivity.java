...
/*专责任务详情*/
public class OverhaulZzWeekTaskDetailActivity extends BaseActivity {
    ...
    private void initId() {  //查询任务
        ...
        BaseRequest.getInstance().getService().getZzTaskInfo(taskId).subscribeOn(Schedulers.io())
                ...
                .subscribe(new BaseObserver<OverhaulZzTaskBean>(this) {
                    @Override
...
////                        if(t.getCode() == 1) {
////                            //result = t.getResults();
////                            Toast.makeText(OverhaulZzWeekTaskDetailActivity.this, "分发成功！", Toast.LENGTH_SHORT).show();
////                            //产生待办
////                            deal();
////                            //更新详情状态
////                            initId();
////                        }else {
////                            Toast.makeText(OverhaulZzWeekTaskDetailActivity.this, "分发失败！", Toast.LENGTH_SHORT).show();
////                        }
////                    }
////
////                    @Override
...
//                        Toast.makeText(OverhaulZzWeekTaskDetailActivity.this, "当前无工作票！", Toast.LENGTH_SHORT).show();
//                    } else {
...
//                        switch (nicePosition) {
//                            case 1:
//                                Intent intent11 = new Intent(OverhaulZzWeekTaskDetailActivity.this, FirstWTicketActivity.class);
//                                intent11.putExtra("bean", overhaulMonthBean);
//                                intent11.putExtra("type", String.valueOf(nicePosition));
//                                intent11.putExtra("task_type", String.valueOf(nicePosition2));
//                                intent11.putExtra("leaderName", leaderName);
...
//                                break;
//                            case 2:
//                                Intent intent12 = new Intent(OverhaulZzWeekTaskDetailActivity.this, SecondWTicketActivity.class);
//                                intent12.putExtra("bean", overhaulMonthBean);
//                                intent12.putExtra("type", String.valueOf(nicePosition));
//                                intent12.putExtra("task_type", String.valueOf(nicePosition2));
//                                intent12.putExtra("leaderName", leaderName);
...
//                                break;
//                            case 3:
//                                Intent intent13 = new Intent(OverhaulZzWeekTaskDetailActivity.this, ThirdWTicketActivity.class);
//                                intent13.putExtra("bean", overhaulMonthBean);
//                                intent13.putExtra("type", String.valueOf(nicePosition));
//                                intent13.putExtra("task_type", String.valueOf(nicePosition2));
//                                intent13.putExtra("leaderName", leaderName);
...
//
//                            case 4:
//                                Intent intent14 = new Intent(OverhaulZzWeekTaskDetailActivity.this, FourWTicketActivity.class);
//                                intent14.putExtra("bean", overhaulMonthBean);
//                                intent14.putExtra("type", String.valueOf(nicePosition));
//                                intent14.putExtra("task_type", String.valueOf(nicePosition2));
//                                intent14.putExtra("leaderName", leaderName);
            ...
            case R.id.control_card:
                ...
                if (allControlCarBean == null) {
                    ...
                    if (allControlCarBean.getCardTool() == null && allControlCarBean.getCardQuality() == null && allControlCarBean.getCardTool().size() == 0) {
                        ...
                        Intent intent2 = new Intent(OverhaulZzWeekTaskDetailActivity.this, ControlCardActivity.class);
        ...
        BaseRequest.getInstance().getService()
                ...
                .subscribe(new BaseObserver(this) {
                    ...
                    protected void onSuccees(BaseResult t) throws Exception {
                        ...
                        if (t.getCode() == 1) {
                            Toast.makeText(OverhaulZzWeekTaskDetailActivity.this, "文件上传成功", Toast.LENGTH_SHORT).show();
                            initId();
                        }
                    }
...
//                        }
//                        Toast.makeText(OverhaulZzWeekTaskDetailActivity.this, "文件下载完成", Toast.LENGTH_SHORT).show();
...
//                            acceptancePlanGrogress.setVisibility(View.GONE);
//                        }
//                        Toast.makeText(OverhaulZzWeekTaskDetailActivity.this, "文件下载失败", Toast.LENGTH_SHORT).show();
//                    }
//
//                    @Override
