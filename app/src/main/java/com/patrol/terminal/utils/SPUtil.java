...
public class SPUtil {
    ...
    public static String getUserId(Context context) {
        SharedPreferences sp = context.getSharedPreferences(Constant.USER,
                Context.MODE_PRIVATE);
        return sp.getString(Constant.USERID, "");
    }
    public static String getDepName(Context context) {
        SharedPreferences sp = context.getSharedPreferences(Constant.USER,
                Context.MODE_PRIVATE);
        return sp.getString(Constant.DEPNAME, "");
    }

    public static String getUserName(Context context) {
        SharedPreferences sp = context.getSharedPreferences(Constant.USER,
                Context.MODE_PRIVATE);
        return sp.getString(Constant.USERNAME, "");
    }
    /**
     * 移除某个key值已经对应的值
     */
    ...
    public static String getTypeId(Context context) {
        String ID = SPUtil.getString(context, Constant.TYPE, Constant.TASKTYPE, "");
        return ID;
    }
}